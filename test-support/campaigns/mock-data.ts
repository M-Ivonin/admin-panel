...
const OVERVIEW_ITEMS = [
  ...
  {
    id: 'cmp_in_app_winback',
    name: 'in_app_winback',
    goal: 'Bring active users back to rewards',
    channel: 'in_app',
    status: 'active',
    entryTriggerType: 'state_based',
    audience: { estimate: 4200, currentEstimate: 3900, label: 'Current Users' },
    timing: { label: 'Next send', timestamp: '2026-04-16T20:00:00.000Z' },
    progress: {
      sentCount: 2,
      totalCount: 4,
      failedCount: 0,
      ...
      ctr: 50,
      progressPercent: 50,
      uniqueRecipientCount: 3,
      journeyInstanceCount: 3,
      deliveryRowCount: 4,
      failureReasons: [{ reason: 'in_app_expired', count: 1 }],
    },
    metric: { label: 'ctr', value: '50.0%' },
    owner: { ownerName: 'CRM bot', activityLabel: 'Active' },
    updatedAt: '2026-04-16T11:56:00.000Z',
    localeReadiness: { en: 'ready', es: 'ready', pt: 'ready' },
  },
  {
    id: 'cmp_hybrid_rewards',
    name: 'hybrid_rewards',
    goal: 'Open rewards wallet',
    channel: 'hybrid',
    status: 'active',
    entryTriggerType: 'state_based',
    audience: { estimate: 5100, currentEstimate: 4860, label: 'Current Users' },
    timing: { label: 'Next send', timestamp: '2026-04-16T21:00:00.000Z' },
    progress: {
      sentCount: 4,
      totalCount: 6,
      failedCount: 1,
      ...
      uniqueRecipientCount: 5,
      journeyInstanceCount: 5,
      deliveryRowCount: 6,
