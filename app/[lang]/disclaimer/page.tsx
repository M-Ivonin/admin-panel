      ...
      <main className="container mx-auto px-4 py-12">
        <article className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-foreground [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mt-8 [&_h2]:mb-4 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-2 [&_p]:mb-4">
            ...
            <p>SirBro does not offer, promote, or facilitate gambling, betting, or wagering of any kind.</p>

            <h2>2. Entertainment Only</h2>
            <p>All predictions, insights, and statistics provided by SirBro are for entertainment and informational purposes only.</p>

            <h2>3. AI-Generated Content</h2>
            <p>Content generated by AI systems may be inaccurate, incomplete, or outdated. Use at your own discretion.</p>

            <h2>4. No Financial Advice</h2>
            <p>SirBro does not provide financial, investment, or betting advice.</p>
