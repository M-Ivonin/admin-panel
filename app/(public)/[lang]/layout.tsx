...
export const metadata: Metadata = {
  ...
  description: 'Football insights, match analysis, team stats, player form, and live signals — all in one place.',
  keywords: ['football', 'insights', 'match analysis', 'team stats', 'player form'],
